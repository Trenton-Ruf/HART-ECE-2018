...
#define RFM69_INT     6 //   . can be any interupt capable pin (input) "All pins can be interrupt inputs"
#define RFM69_RST     9 //   . can be any digital pin (output)
#define RFM69_ENABLE  10 //  . can be any digital pin (output)
